...
<html>
    ...
    <body
        class="${pageProperty(name:'body.class')?:'nav-collections'}"
        id="${pageProperty(name:'body.id')}"
        onload="${pageProperty(name:'body.onload')}"
        data-offset="${pageProperty(name:'body.data-offset')}"
        data-target="${pageProperty(name:'body.data-target')}"
        data-spy="${pageProperty(name:'body.data-spy')}"
    >
            ...
            <div class="navbar-inner contain-to-grid">
                <div class="${fluidLayout?'container-fluid':'container'}">
                    ...
                    <a class="brand" href="http://ala.org.au/" id="alaLink" title="ALA home page">
                        ...
                        <div id="alaHeadingText">
                            <div id="poweredBy">
                                powered by
                            </div>
                            <div id="alaBy" class="visible-desktop">
                    ...
                    <div class="pull-right">
                        <div class="nav-collapse collapse pull-right">
                            <ul class="nav">
                                <li>
                                    <a href="${grailsApplication.config.skin.homeURL}/index">
                                        Home
                                    </a>
                                </li>

                                <li>
                                    <a href="${grailsApplication.config.skin.homeURL}/occurrences/search?fq=data_hub_uid:dh10#tab_mapView">
                                        Search
                                    </a>
                                </li>

                                <li>
                                    <a href="${grailsApplication.config.skin.homeURL}/about">
                                        About
                                    </a>
                                </li>

                                <li>
                                    <a href="${grailsApplication.config.skin.homeURL}/help">
                                        Help
                                    </a>
                                </li>
                                ...
                                <g:if test="${!!authService.getUserId()}">
                                    <li>
                                        <a href="${grailsApplication.config.grails.serverURL}/logout/logout?casUrl=${grailsApplication.config.casServerUrlPrefix}/logout&appUrl=${grailsApplication.config.serverName}${request.forwardURI}">
                                            Logout
                                        </a>
                                    </li>
                                </g:if>
            ...
            <div class="${fluidLayout?'container-fluid':'container'}">
                <div class="row  navbar-inverse">
                    <div class="span6">
                        <ul class="nav">
                            <li>
                                <a href="${grailsApplication.config.skin.homeURL}/contact">
                                    Contact us
                                </a>
                            </li>
                            <li>
                                <a href="${grailsApplication.config.skin.homeURL}/access">
                                    Accessibility
                                </a>
                            </li>
                            <li>
                                <a href="${grailsApplication.config.skin.homeURL}/disclaim">
                                    Disclaimer
                                </a>
                            </li>
                        </ul>

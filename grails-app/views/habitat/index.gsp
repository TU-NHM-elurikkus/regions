...
<html>
    <head>
        ...
        <title>
            Habitats | ${grailsApplication.config.orgNameLong}
        </title>
        ...
        <div class="row-fluid" style="margin-top:10px;">
            ...
            <div class="span8" id="rightPanel">
                <div class="actions pull-right">
                    <a id="viewRecordsLink" class='btn hide' href='#'>
                ...
                <span id="click-info">
                    ...
                    Select a habitat from the tree to view on map.
                </span>
                <a id="selected-habitat" class='btn hide' href='#'>
                    View habitat
                </a>
                <div id="map-canvas" style="width:100%; height:600px; margin-top:10px;"></div>
            </div>
        </div>
